...
def mysql_stress_test():
    ...
    try:
        ...
        query = """
        select genre, count(*) movie_count from
          genre join movie on id=genre.movie_id
          join ratings on id=ratings.movie_id where
          date_published like '2017-03%' and country='USA' and total_votes>1000
          group by (genre);
